  ...
  const products = {
    ...
    gold: [
      ...
      { 
        ...
        type: "NECKLACE", 
        price: "₹ 2,15,999", 
        description: "Exquisite traditional necklace with multi-strand gold bead chains, intricately carved floral pendant with ruby accents, leaf motifs, and pearl drop", 
      ...
      { 
        id: 206, 
        name: "Royal Peacock Design Gold Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 3,25,999", 
        description: "Stunning peacock-inspired choker with layered mango motifs, ruby and emerald stone work, pearl droplets, and central teardrop pendant with pearl drop", 
      ...
      { 
        id: 207, 
        name: "Antique Kundan Choker Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 2,95,999", 
        description: "Opulent antique-finish choker with intricate filigree work, emerald and ruby cabochons, gold bead strands, and ruby bead drop embellishments", 
        material: "22K Gold with Emerald & Ruby", 
        purity: "BIS Hallmarked",
        weight: "102.5 grams", 
        dimensions: "38 cm length",
        category: "Gold" 
      },
      { 
        id: 208, 
        name: "Temple Lakshmi Gold Long Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 2,45,999", 
        description: "Traditional temple jewelry long necklace with mesh chain work, circular coin motifs, ruby accents, Lakshmi pendant, and ruby bead danglers", 
        material: "22K Gold with Ruby", 
        purity: "BIS Hallmarked",
        weight: "88.3 grams", 
        dimensions: "65 cm length",
        category: "Gold" 
      },
      { 
        id: 209, 
        name: "Peacock Enamel Gold Ball Necklace", 
        image: imgNecklace209, 
        images: [imgNecklace209], 
        rating: 4.7, 
        reviewCount: 198, 
        type: "NECKLACE", 
        price: "₹ 1,95,999", 
        description: "Elegant gold ball cluster necklace with red dori, vibrant meenakari peacock centerpiece featuring multicolor enamel work and gold bead accents", 
        material: "22K Gold with Meenakari Enamel", 
        purity: "BIS Hallmarked",
        weight: "72.8 grams", 
      ...
      { 
        id: 210, 
        name: "Traditional Antique Gold Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 2,05,999", 
        description: "Classic antique gold necklace with multi-strand bead chains, circular medallion patterns, ruby and emerald accents, ornate central pendant with gold ball drops", 
      ...
      { 
        id: 211, 
        name: "Polki Emerald Pearl Bridal Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 4,85,999", 
        description: "Magnificent multi-strand bridal necklace with lustrous pearls, emerald beads, uncut polki diamonds, sunburst ruby pendant with jhumka drop", 
        material: "22K Gold with Polki, Ruby, Emerald & Pearl", 
        purity: "BIS Hallmarked",
        weight: "125.6 grams", 
      ...
      { 
        id: 212, 
        name: "Antique Emerald Two-Layer Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 2,75,999", 
        description: "Stunning two-layered antique necklace with emerald cabochons, intricate spiral filigree work, gold bead embellishments, and ornate pendant with pearl accents", 
        material: "22K Gold with Emerald & Pearl", 
        purity: "BIS Hallmarked",
        weight: "92.4 grams", 
      ...
      { 
        id: 213, 
        name: "Contemporary Floral Gold Necklace", 
        ...
        type: "NECKLACE", 
        price: "₹ 1,65,999", 
        description: "Modern design necklace with geometric square panels, purple and green gemstone cabochons, gold bead chain, circular loop danglers with floral accents", 
        material: "22K Gold with Amethyst & Emerald", 
        purity: "BIS Hallmarked",
        weight: "68.7 grams", 
