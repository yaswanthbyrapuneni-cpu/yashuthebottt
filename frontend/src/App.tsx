...
export default function App() {
  ...
  const products = {
    ...
    gold: [
      ...
      // { id: 17, name: "Modern Forehead Chain", image: imgManpathi, images: [imgManpathi], rating: 4.8, reviewCount: 45, type: "MATHAPATTI", price: "₹45,999", description: "Contemporary mathapatti design with delicate chain pattern...", material: "22K Gold", weight: "25 grams", category: "Gold" },
  ...
  if (showAdminDashboard) {
    return <AlankaraAiDashboard onExit={() => setShowAdminDashboard(false)} />;
  }
    ...
    <>
             ...
             <button
              ...
              onClick={() => {
                ...
                if (category === "Book Now") {
                  ...
                  setShowAdminDashboard(false); // Ensure admin is hidden
                  // CHANGE: Toggle dropdown for non-Book Now categories
      ...
      <div className="content-stretch flex flex-col gap-[64px] items-start relative shrink-0 w-full py-[64px]">
        ...
        */}
        ...
        {/* Video Playlist Section — unmounted while Try On is open */}
        {!tryOnModal.isOpen && (
